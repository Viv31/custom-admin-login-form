...
Donate link: 
Tags: Custom admin login,admin login custom form
...
= How can I apply background color? =
In background color section add your color and it will apply background color,if you are applying background image and color both so it will take background image not color.
